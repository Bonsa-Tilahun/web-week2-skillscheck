...
// CODE HERE
let faveColors = ['blue', 'green', 'purple']
    //////////////////Step 2////////////////////
...
let me = {
        firstName: 'bonsa',
        homeTown: 'nekemte',
        superHeroName: 'avatar',
        superPowers: ['control four elements', 'fly', 'teleportation'],
        superPowerXP: function() {
            return this.superPowers[Math.floor(Math.random() * 100) + 1]
        },
