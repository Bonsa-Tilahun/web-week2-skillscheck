...
//Code here
let oddChecker = num => num % 2 === 0 ? 'the number is even' : 'the number is odd'
    //////////////////PROBLEM 7////////////////////
...
//Code Here
let colorCopy = faveColors.slice(e => e)
    //////////////////PROBLEM 9////////////////////
...
let bigOrSmall = arr => {
        let answers = []
        arr.forEach(element => {
            element > 100 ? answers.push('big') : answers.push('small')
        });
        return answers
    }
    //////////////////PROBLEM 13////////////////////
...
// Code Here
let filtered = myNumbers.filter(e => e > 100)
    //////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce((acc, e) => acc + e, 0)
    //////////////////PROBLEM 17////////////////////
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(e => 'George')
...
// Code Here
let enemies = people.filter(e => !e.friend ? e : null)
    //////////////////PROBLEM 20////////////////////
...
// Code Here
let totallyAwesome = people.reduce((total, person) => total += person.awesomeLevel, 0)